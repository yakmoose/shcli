...
func init() {
	addCmd.Flags().StringP("server", "S", "", "The server add the stack to")
	addCmd.MarkFlagRequired("server")

	addCmd.Flags().StringP("label", "l", "", "The stack label")
	addCmd.MarkFlagRequired("label")

	addCmd.Flags().StringP("name", "n", "", "The stack name, should be generated by a call to generatename")
	addCmd.MarkFlagRequired("name")

	addCmd.Flags().StringP("compose-file", "c", "", "The docker compose file")
	addCmd.MarkFlagRequired("compose-file")

	addCmd.Flags().StringP("environment-file", "e", "", "The environment")

	addCmd.Flags().BoolP("enableSSL", "", false, "Enable ssl")
