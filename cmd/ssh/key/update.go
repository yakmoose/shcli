...
// updateCmd updates the spcified key with the supplied details
...
func init() {
	...
	updateCmd.Flags().StringP("label", "l", "", "The key label")
	updateCmd.MarkFlagRequired("label")

	updateCmd.Flags().StringP("keyid", "", "", "The key id")
	updateCmd.MarkFlagRequired("keyid")

	updateCmd.Flags().StringP("key", "k", "", "The key file")
