...
// dnsRecordsListCmd represents the list command
var dnsRecordsListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		records, err := client.ListRecords(context.Background(), goshDns.ListRecordsRequest{Domain: domainName})
		if err != nil {
			return err
		}
...
func init() {
	dnsRecordsListCmd.Flags().StringP("rr_type", "t", "", "Filter record RR types")
}
